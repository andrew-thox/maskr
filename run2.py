...
from samples.watches.balloon import BalloonConfig, train

ZIP_FILE_URL = "https://s3.eu-west-2.amazonaws.com/vagabond-data/compressed_datasets/watches.zip"
